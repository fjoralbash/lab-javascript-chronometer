...
let milsecDec = document.getElementById('milDec');
let milsecUni = document.getElementById('milUni');
...
function printMilliSeconds() {
  ...
  milsecDec.textContent = milliseconds[0];
  milsecUni.textContent = milliseconds[1];
}
